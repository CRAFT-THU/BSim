...
class TestLIF(unittest.TestCase):
    def test_run(self):
        ...
        p0 = net.population(lif, num=N, name='P0', v=0.0, v_rest=0.0, v_reset=0.0,
                            ...
                            i_offset=1.0, refract_time=0.00)
        ...
        s01 = net.projection(static, num=N*N, name='S01', weight=0.002,
                             delay=0.0001)
        s12 = net.projection(static, num=N*N, name='S12', weight=0.002,
                             delay=0.0001)
        s23 = net.projection(static, num=N*N, name='S23', weight=0.002,
                             delay=0.0001)
        s34 = net.projection(static, num=N*N, name='S34', weight=0.002,
                             delay=0.0001)
        s45 = net.projection(static, num=N*N, name='S45', weight=0.002,
                             delay=0.0001)
