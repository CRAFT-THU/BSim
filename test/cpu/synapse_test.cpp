...
{
	Network c;
	Population<IF_curr_exp> *pn1 = c.createPopulation(0, 1, IF_curr_exp(LIFNeuron(ID(0, 0), 0.0f, 0.0f, 0.0f, 1.0e-1f, 10.0e-3f, 0.0f, 1.0f, 1.0f, 15.0e-3f, 2.0e-1f), ID(0, nidTag.getTag())));
