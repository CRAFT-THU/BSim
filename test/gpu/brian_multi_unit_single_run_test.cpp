...
int main(int argc, char **argv)
{
	...
	Population<LIF_curr_exp> *pn0 = c.createPopulation(N, LIF_curr_exp(LIFNeuron(0.0, 0.0, 0.0, 1.0e-1, 50.0e-3, 0.0, 1.0, 1.0, 15.0e-3, 0e-1), 1.0, 1.0));
	Population<LIF_curr_exp> *pn1 = c.createPopulation(N, LIF_curr_exp(LIFNeuron(0.0, 0.0, 0.0, 1.0e-1, 50.0e-3, 0.0, 1.0, 1.0, 15.0e-3, 10e-1), 1.0, 1.0));
	...
	Population<LIF_curr_exp> *pn4 = c.createPopulation(N, LIF_curr_exp(LIFNeuron(0.0, 0.0, 0.0, 1.0e-1, 50.0e-3, 0.0, 1.0, 1.0, 15.0e-3, 0.0e-3), 1.0, 1.0));
	...
	if (load) { 
		...
		//}
		weight0 = getConstArray((real)3e-3, N*N);
		weight1 = getConstArray((real)4e-3, N*N);
