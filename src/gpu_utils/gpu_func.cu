...
int (*cudaAllocType[])(void *, void *, int) = { cudaAllocConstantNeurons, cudaAllocLIFNeurons, /*cudaAllocNengoNeurons, cudaAllocInputNeurons, cudaAllocPossionNeurons, cudaAllocProbeNeurons, cudaAllocBasicSynapses, cudaAllocAlphaSynapses,*/ cudaAllocExpSynapses/*, cudaAllocLowpassSynapses*/ };
