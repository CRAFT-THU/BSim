...
def generate_cu_file(func, type_name, type_type, path_name):
    ...
    f.write("\t\t\tcommit2globalTable(fire_table_t, MAXBLOCKSIZE, gFiredTable, &gFiredTableSizes[gCurrentIdx], gFiredTableCap*gCurrentIdx);\n")
    f.write("\t\t\tif (threadIdx.x == 0) {\n")
    f.write("\t\t\t\tfire_cnt = 0;\n")
    f.write("\t\t\t}\n")
    f.write("\t\t}\n")
    ...
    f.write("\t\t\tcommit2globalTable(fire_table_t, fire_cnt, gFiredTable, &gFiredTableSizes[gCurrentIdx], gFiredTableCap*gCurrentIdx);\n")
    f.write("\t\t\tif (threadIdx.x == 0) {\n")
    f.write("\t\t\t\tfire_cnt = 0;\n")
    f.write("\t\t\t}\n")
    f.write("\t\t}\n")
