...
Lif_curr_exp * to_gpu_lif_curr_exp(Lif_curr_exp *cpu, int num)
{
	...
	checkCudaErrors(cudaMemset(gpu->p_v_tmp, 0, sizeof(float)*num));
	...
	checkCudaErrors(cudaMemset(gpu->p_v_reset, 0, sizeof(float)*num));
	...
	checkCudaErrors(cudaMemset(gpu->p_Cexec, 0, sizeof(float)*num));
	...
	checkCudaErrors(cudaMemset(gpu->p_C_exec, 0, sizeof(float)*num));
	...
	checkCudaErrors(cudaMemset(gpu->p_C_inh, 0, sizeof(float)*num));
	...
	checkCudaErrors(cudaMemset(gpu->p_v_threshold, 0, sizeof(float)*num));
	...
	checkCudaErrors(cudaMemset(gpu->p_Cm, 0, sizeof(float)*num));
	...
	checkCudaErrors(cudaMemset(gpu->p_Cinh, 0, sizeof(float)*num));
	...
	checkCudaErrors(cudaMemset(gpu->p_v, 0, sizeof(float)*num));
