...
class TestPopulationMethods(unittest.TestCase):
    def test_data(self):
        ...
        p1 = Population(LIF_curr_exp, num=10, name='P1', v=0.0, Cm=1.0, v_tmp=2.0, C_exec=0.8, C_inh=0.6, Cexc=0.5, Cinh=0.3, v_threshold=20.0, v_reset=0.0)
        p2 = Population(LIF_curr_exp, num=5, name='P1', v=1.0, Cm=2.0, v_tmp=3.0, C_exec=0.7, C_inh=0.5, Cexc=0.6, Cinh=0.4, v_threshold=25.0, v_reset=-10.0)
